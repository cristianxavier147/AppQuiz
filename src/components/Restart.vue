<template>
  <div class="text-gray-700 w/11-12 mx-auto flex flex-col items-center">
    <h1 class="my-12 text-center text-lg font-medium">
      Has acertado en {{ store.score }} de {{ store.questionCount }} preguntas.
    </h1>
    <button
      @click="store.restartQuiz()"
      class="bg-gray-200 rounded-lg px-12 py-4 transition md:text-lg hover:bg-gray-300"
    >
      <div class="flex items-center">
        <span class="mr-3">Volver a intentar</span>
        <svg
          width="24"
          height="24"
